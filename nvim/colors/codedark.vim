...
" "vendored" in from and all credits to https://github.com/tomasiser/vim-code-dark
...
let s:cdPopupBack = {'gui': '#393F4A', 'cterm': s:cterm01, 'cterm256': '236'}
...
call <sid>hi('DiffChange', s:cdNone, s:cdDiffBlue, 'none', {})
call <sid>hi('DiffDelete', s:cdNone, s:cdDiffRedLight, 'none', {})
call <sid>hi('DiffText', s:cdNone, s:cdDiffBlueLight, 'none', {})
...
call <sid>hi('ModeMsg', s:cdNone, s:cdNone, 'none', {})
...
call <sid>hi('StatusLine', s:cdNone, s:cdLeftMid, 'none', {})
call <sid>hi('StatusLineNC', s:cdNone, s:cdLeftDark, 'none', {})
call <sid>hi('TabLine', s:cdNone, s:cdTabOther, 'none', {})
call <sid>hi('TabLineFill', s:cdNone, s:cdTabOutside, 'none', {})
call <sid>hi('TabLineSel', s:cdNone, s:cdTabCurrent, 'none', {})
...
call <sid>hi('netrwMarkFile', s:cdNone, s:cdSelection, 'none', {})
...
call <sid>hi('Identifier', s:cdNone, {}, 'none', {})
...
call <sid>hi('Operator', s:cdNone, {}, 'none', {})
...
call <sid>hi('SpecialChar', s:cdNone, {}, 'none', {})
call <sid>hi('Tag', s:cdNone, {}, 'none', {})
call <sid>hi('Delimiter', s:cdNone, {}, 'none', {})
if g:codedark_italics | call <sid>hi('SpecialComment', s:cdGreen, {}, 'italic', {}) | else | call <sid>hi('SpecialComment', s:cdGreen, {}, 'none', {}) | endif
call <sid>hi('Debug', s:cdNone, {}, 'none', {})
call <sid>hi('Underlined', s:cdNone, {}, 'underline', {})
call <sid>hi("Conceal", s:cdNone, s:cdNone, 'none', {})
call <sid>hi('Ignore', s:cdNone, {}, 'none', {})
...
if has("nvim")
    ...
    " Constant
    call <sid>hiTS('@constant', 'TSConstant', s:cdNone, {}, 'none', {})
    ...
    call <sid>hiTS('@annotation', 'TSAnnotation', s:cdNone, {}, 'none', {})
    ...
    call <sid>hiTS('@parameter', 'TSParameter', s:cdNone, {}, 'none', {})
    call <sid>hiTS('@parameter.reference', 'TSParameterReference', s:cdNone, {}, 'none', {})
    call <sid>hiTS('@method', 'TSMethod', s:cdNone, {}, 'none', {})
    call <sid>hiTS('@field', 'TSField', s:cdNone, {}, 'none', {})
    call <sid>hiTS('@property', 'TSProperty', s:cdNone, {}, 'none', {})
    ...
    call <sid>hiTS('@label', 'TSLabel', s:cdNone, {}, 'none', {})
    ...
    call <sid>hiTS('@operator', 'TSOperator', s:cdNone, {}, 'none', {})
    call <sid>hiTS('@exception', 'TSException', s:cdBlue, {}, 'none', {})
    call <sid>hiTS('@type', 'TSType', s:cdBlueGreen, {}, 'none', {})
    call <sid>hiTSlink('@type.builtin', 'TSTypeBuiltin', 'Type')
    call <sid>hi('TSStructure', s:cdNone, {}, 'none', {})
    call <sid>hiTSlink('@include', 'TSInclude', 'Include')
    " Variable
    call <sid>hiTS('@variable', 'TSVariable', s:cdNone, {}, 'none', {})
    call <sid>hiTS('@variable.builtin', 'TSVariableBuiltin', s:cdNone, {}, 'none', {})
    " Text
    call <sid>hiTS('@text', 'TSText', s:cdNone, s:cdNone, 'bold', {})
    call <sid>hiTS('@text.strong', 'TSStrong', s:cdNone, s:cdNone, 'bold', {})
    ...
    call <sid>hi('CmpItemKindVariable', s:cdNone, {}, 'none', {})
    call <sid>hi('CmpItemKindInterface', s:cdNone, {}, 'none', {})
    call <sid>hi('CmpItemKindText', s:cdNone, {}, 'none', {})
    call <sid>hi('CmpItemKindFunction', s:cdBlue, {}, 'none', {})
    call <sid>hi('CmpItemKindMethod ', s:cdBlue, {}, 'none', {})
    call <sid>hi('CmpItemKindKeyword', s:cdNone, {}, 'none', {})
    call <sid>hi('CmpItemKindProperty', s:cdNone, {}, 'none', {})
    call <sid>hi('CmpItemKindUnit', s:cdNone, {}, 'none', {})
endif
...
call <sid>hi('markdownUrl', s:cdNone, {}, 'underline', {})
...
call <sid>hi("asciidocTriplePlusPassthrough", s:cdNone, {}, 'none', {})
...
" JSON (built-in)
call <sid>hi('jsonKeyword', s:cdNone, {}, 'none', {})
...
call <sid>hi('htmlArg', s:cdNone, {}, 'none', {})

" PHP (built-in)
call <sid>hi('phpClass', s:cdBlueGreen, {}, 'none', {})
hi! link phpUseClass phpClass
hi! link phpStaticClasses phpClass
call <sid>hi('phpMethod', s:cdNone, {}, 'none', {})
call <sid>hi('phpFunction', s:cdNone, {}, 'none', {})
call <sid>hi('phpInclude', s:cdBlue, {}, 'none', {})
call <sid>hi('phpRegion', s:cdBlueGreen, {}, 'none', {})
call <sid>hi('phpMethodsVar', s:cdNone, {}, 'none', {})

" CSS (built-in)
call <sid>hi('cssBraces', s:cdNone, {}, 'none', {})
...
call <sid>hi('cssProp', s:cdNone, {}, 'none', {})
call <sid>hi('cssDefinition', s:cdNone, {}, 'none', {})
call <sid>hi('cssAttr', s:cdOrange, {}, 'none', {})
call <sid>hi('cssAttrRegion', s:cdOrange, {}, 'none', {})
call <sid>hi('cssColor', s:cdOrange, {}, 'none', {})
call <sid>hi('cssFunction', s:cdNone, {}, 'none', {})
call <sid>hi('cssFunctionName', s:cdNone, {}, 'none', {})
...
call <sid>hi('cssStyle', s:cdNone, {}, 'none', {})
call <sid>hi('cssImportant', s:cdBlue, {}, 'none', {})
call <sid>hi('cssSelectorOp', s:cdNone, {}, 'none', {})
call <sid>hi('cssKeyFrameProp2', s:cdLightGreen, {}, 'none', {})

" JavaScript:
call <sid>hi('jsVariableDef', s:cdNone, {}, 'none', {})
call <sid>hi('jsFuncArgs', s:cdNone, {}, 'none', {})
call <sid>hi('jsFuncBlock', s:cdNone, {}, 'none', {})
call <sid>hi('jsRegexpString', s:cdOrange, {}, 'none', {})
call <sid>hi('jsThis', s:cdBlue, {}, 'none', {})
call <sid>hi('jsOperatorKeyword', s:cdBlue, {}, 'none', {})
call <sid>hi('jsDestructuringBlock', s:cdNone, {}, 'none', {})
call <sid>hi('jsObjectKey', s:cdNone, {}, 'none', {})
call <sid>hi('jsGlobalObjects', s:cdBlueGreen, {}, 'none', {})
call <sid>hi('jsModuleKeyword', s:cdNone, {}, 'none', {})
...
call <sid>hi('jsExportDefault', s:cdBlue, {}, 'none', {})
call <sid>hi('jsFuncCall', s:cdNone, {}, 'none', {})
call <sid>hi('jsObjectValue', s:cdNone, {}, 'none', {})
call <sid>hi('jsParen', s:cdNone, {}, 'none', {})
call <sid>hi('jsObjectProp', s:cdNone, {}, 'none', {})
call <sid>hi('jsIfElseBlock', s:cdNone, {}, 'none', {})
call <sid>hi('jsParenIfElse', s:cdNone, {}, 'none', {})
call <sid>hi('jsSpreadOperator', s:cdNone, {}, 'none', {})
call <sid>hi('jsSpreadExpression', s:cdNone, {}, 'none', {})

" Vue:
call <sid>hi('VueComponentName', s:cdBlueGreen, {}, 'none', {})
call <sid>hi('VueValue', s:cdNone, {}, 'none', {})
call <sid>hi('VueBrace', s:cdYellowOrange, {}, 'none', {})
call <sid>hi('VueExpression', s:cdNone, {}, 'none', {})
call <sid>hi('VueTag', s:cdNone, {}, 'none', {})
call <sid>hi('VueKey', s:cdBlue, {}, 'none', {})

" Typescript:
call <sid>hi('typescriptLabel', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptTry', s:cdBlue, {}, 'none', {})
call <sid>hi('typescriptExceptions', s:cdBlue, {}, 'none', {})
call <sid>hi('typescriptBraces', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptEndColons', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptParens', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptDocTags', s:cdBlue, {}, 'none', {})
call <sid>hi('typescriptDocComment', s:cdBlueGreen, {}, 'none', {})
call <sid>hi('typescriptLogicSymbols', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptImport', s:cdBlue, {}, 'none', {})
call <sid>hi('typescriptBOM', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptVariableDeclaration', s:cdNone, {}, 'none', {})
...
call <sid>hi('typescriptMember', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptTypeReference', s:cdBlueGreen, {}, 'none', {})
call <sid>hi('typescriptDefault', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptTemplateSB', s:cdYellowOrange, {}, 'none', {})
call <sid>hi('typescriptArrowFuncArg', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptParamImpl', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptFuncComma', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptCastKeyword', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptCall', s:cdBlue, {}, 'none', {})
call <sid>hi('typescriptCase', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptReserved', s:cdBlue, {}, 'none', {})
call <sid>hi('typescriptDefault', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptDecorator', s:cdNone, {}, 'none', {})
...
call <sid>hi('typescriptBlock', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptDOMDocProp', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptTemplateSubstitution', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptClassBlock', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptFuncCallArg', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptIndexExpr', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptConditionalParen', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptArray', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptES6SetProp', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptObjectLiteral', s:cdNone, {}, 'none', {})
...
call <sid>hi('typescriptLoopParen', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptParenExp', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptModule', s:cdNone, {}, 'none', {})
...
call <sid>hi('typescriptGlobalMethod', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptPromiseMethod', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptIdentifierName', s:cdNone, {}, 'none', {})
call <sid>hi('typescriptCacheMethod', s:cdNone, {}, 'none', {})
...
call <sid>hi('goBuiltins', s:cdNone, {}, 'none', {})
...
call <sid>hi('goVarAssign', s:cdNone, {}, 'none', {})
call <sid>hi('goVarDefs', s:cdNone, {}, 'none', {})
call <sid>hi('goReceiver', s:cdNone, {}, 'none', {})
call <sid>hi('goReceiverType', s:cdNone, {}, 'none', {})
call <sid>hi('goFunctionCall', s:cdNone, {}, 'none', {})
call <sid>hi('goMethodCall', s:cdNone, {}, 'none', {})
call <sid>hi('goSingleDecl', s:cdNone, {}, 'none', {})

" Python:
call <sid>hi('pythonStatement', s:cdBlue, {}, 'none', {})
call <sid>hi('pythonOperator', s:cdBlue, {}, 'none', {})
call <sid>hi('pythonException', s:cdBlue, {}, 'none', {})
call <sid>hi('pythonExClass', s:cdBlueGreen, {}, 'none', {})
call <sid>hi('pythonBuiltinObj', s:cdNone, {}, 'none', {})
...
call <sid>hi('texBeginEnd', s:cdNone, {}, 'none', {})
call <sid>hi('texBeginEndName', s:cdNone, {}, 'none', {})
call <sid>hi('texOption', s:cdNone, {}, 'none', {})
call <sid>hi('texBeginEndModifier', s:cdNone, {}, 'none', {})
call <sid>hi('texDocType', s:cdBlue, {}, 'none', {})
call <sid>hi('texDocTypeArgs', s:cdNone, {}, 'none', {})
...
" Lua:
call <sid>hi('luaFuncCall', s:cdNone, {}, 'none', {})
call <sid>hi('luaFuncArgName', s:cdNone, {}, 'none', {})
call <sid>hi('luaFuncKeyword', s:cdBlue, {}, 'none', {})
call <sid>hi('luaLocal', s:cdBlue, {}, 'none', {})
call <sid>hi('luaBuiltIn', s:cdBlue, {}, 'none', {})

" SH:
call <sid>hi('shDeref', s:cdNone, {}, 'none', {})
call <sid>hi('shVariable', s:cdNone, {}, 'none', {})

" SQL:
call <sid>hi('sqlKeyword', s:cdBlue, {}, 'none', {})
call <sid>hi('sqlFunction', s:cdYellowOrange, {}, 'none', {})
call <sid>hi('sqlOperator', s:cdBlue, {}, 'none', {})
...
call <sid>hi('MemberRef', s:cdNone, {}, 'italic', {})
call <sid>hi('MemberRefExpr', s:cdNone, {}, 'italic', {})
